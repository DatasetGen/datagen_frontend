...
const paginationStyles = tv({
    slots: {
        container: "flex gap-3 select-none bg-gray-100 w-fit p-2 rounded-xl border-[1px] border-gray-200",
        button: "flex cursor-pointer justify-center items-center p-2 rounded-lg hover:bg-gray-200 transition",
