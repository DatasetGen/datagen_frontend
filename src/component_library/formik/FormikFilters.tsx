...
function withFilters<T>(Component: React.ComponentType<any>, initialValues: T & FormikValues) {
    const WrappedComponent = (props: React.ComponentProps<typeof Component>) => {
        return (
            <Formik enableReinitialize onSubmit={() => {}} initialValues={initialValues}>
                <Component {...props} />
            </Formik>
        );
    };
