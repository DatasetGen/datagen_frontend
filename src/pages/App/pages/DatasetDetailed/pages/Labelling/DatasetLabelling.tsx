        ...
        <FetchLayout statusArray={[categoryStatus ]}>
            ...
            <div className="gap-2 mt-5 overflow-auto w-full">
                <div className="flex gap-3 overflow-hidden w-fit min-w-full">
                    <div className="bg-gray-100 p-4  sticky rounded-xl h-[76vh] w-[350px] z-30 overflow-auto">
                        <Title>Batch</Title>
                    ...
                    <div className="bg-gray-100 p-4  sticky rounded-xl h-[76vh] overflow-auto w-[350px] z-3">
                        <DatasetJobColumn title="In progress" filters={{done: false}}></DatasetJobColumn>
                    </div>
                    <div className="bg-gray-100 p-4  sticky rounded-xl h-[76vh] overflow-auto w-[350px] z-2">
                        <DatasetJobColumn title="Reviewing" filters={{done: true, reviewed: false}}></DatasetJobColumn>
                    </div>
                    <div className="bg-gray-100 p-4  sticky rounded-xl h-[76vh] overflow-auto w-[350px]">
