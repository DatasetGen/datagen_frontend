...
function UploadFilesPage() {
  ...
  return (
    <PageLayout title="Upload Files">
      <Formik className="grid" initialValues={{name: formatDate(new Date()),  zip_file: [] as File[]}} onSubmit={async (values, helpers) => {
        setProgress(0);
            ...
            isSubmitting ?
              ...
              <div className="grid gap-4 mt-8">
                ...
                <div className="w-full justify-center flex  gap-3 max-w-[300px] mt-4 mx-auto">
                  <FormikButton size="md">Upload</FormikButton>
                </div>
              </div>
          )
        }
